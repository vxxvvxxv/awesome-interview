...
В многопоточных и многогорутинных средах используются следующие примитивы:
...
## Подробнее про остальные примитивы в Go
...
#### Когда нужна `sync.Map`, если есть map + mutex
